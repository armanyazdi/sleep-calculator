...
public class SleepCalculator {
    ...
    public static void bedTime() {
        ...
        String choice = inputNumber.nextLine();
        ...
        if (choice.equals("1")) {
            try {
                ...
                String wakeUpTime = inputTime.nextLine();
            ...
            System.out.println(ConsoleColors.RED_BOLD + "Exception: Invalid input!" + ConsoleColors.RESET);
    }
}
